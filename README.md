...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,50:2c5364,100:00c6ff&height=220&section=header&text=7%20Days%20%E2%80%A2%207%20DA%20Case%20Studies&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Real%20Datasets.%20Real%20Industries.%20Real%20Business%20Decisions.&descAlignY=58&descSize=18" width="100%"/>

<br>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=2800&pause=800&color=00C6FF&center=true&vCenter=true&width=780&lines=7+Industries.+7+Datasets.+7+Decisions.;E-commerce+%E2%86%92+SaaS+%E2%86%92+HR+%E2%86%92+Retail;Marketing+%E2%86%92+Banking+%E2%86%92+Food+Delivery;One+Process.+Seven+Domains.+Zero+Repeats.)](https://git.io/typing-svg)

<br>

![Days Completed](https://img.shields.io/badge/Days_Completed-7%2F7-00c853?style=for-the-badge&labelColor=1a1a2e)
![Case Studies](https://img.shields.io/badge/Case_Studies-7-2979ff?style=for-the-badge&labelColor=1a1a2e)
![Domains](https://img.shields.io/badge/Industries_Covered-7-ff6d00?style=for-the-badge&labelColor=1a1a2e)
![Status](https://img.shields.io/badge/Status-Completed-6a1b9a?style=for-the-badge&labelColor=1a1a2e)

![Profile Views](https://komarev.com/ghpvc/?username=SankalpSinghRanaut&label=Repo%20Views&color=2c5364&style=flat-square)
![Last Commit](https://img.shields.io/github/last-commit/SankalpSinghRanaut/7-Days-7-DA-Project-and-Case-Study?style=flat-square&color=2c5364)
![Repo Size](https://img.shields.io/github/repo-size/SankalpSinghRanaut/7-Days-7-DA-Project-and-Case-Study?style=flat-square&color=2c5364)
![Stars](https://img.shields.io/github/stars/SankalpSinghRanaut/7-Days-7-DA-Project-and-Case-Study?style=flat-square&color=2c5364)
...
> [!NOTE]
> Most portfolios explore **one dataset, ten different ways**. This project flips that: **one repeatable analytical process, applied to seven completely different industries** — each with its own data, stakeholders, and definition of "success." The goal wasn't domain expertise. It was proving the *process* generalizes.

Every business — retail, SaaS, HR, banking, marketing, food delivery — sits on top of data it isn't fully using. Over 7 days, I picked a new industry each day, took a messy real-world dataset, and worked it end-to-end: raw rows → EDA → insight → a recommendation someone could actually act on.
...
```mermaid
flowchart LR
    A["📥 Raw Dataset"] --> B["🧹 Clean & Structure"]
    B --> C["🔎 Explore & Segment"]
    C --> D["📊 Analyze Drivers"]
    D --> E["💡 Business Insight"]
    E --> F["✅ Actionable Recommendation"]

    style A fill:#1a1a2e,stroke:#00c6ff,color:#fff
    style B fill:#16213e,stroke:#00c6ff,color:#fff
    style C fill:#0f3460,stroke:#00c6ff,color:#fff
    style D fill:#16213e,stroke:#00c6ff,color:#fff
    style E fill:#1a1a2e,stroke:#ff6d00,color:#fff
    style F fill:#0f3460,stroke:#00c853,color:#fff
```

```mermaid
timeline
    title 7-Day Sprint Across Industries
    Day 1 : E-commerce — Customer & Sales Behavior
    Day 2 : SaaS — Subscription & Churn
    Day 3 : HR — Employee Attrition
...
| # | Industry | Business Question | Case Study |
|:-:|:---------|:-------------------|:-:|
...
<details open>
<summary><b>Day 1 — 🛒 E-commerce: Customer & Sales Behavior Analysis</b></summary>
<br>
...
<details>
<summary><b>Day 2 — 💻 SaaS: Subscription & Churn Analysis</b></summary>
<br>
...
<details>
<summary><b>Day 3 — 🧑‍💼 HR: Employee Attrition</b></summary>
<br>
...
<details>
<summary><b>Day 4 — 🏬 Retail: Store Sales Performance</b></summary>
<br>
...
<details>
<summary><b>Day 5 — 📣 Marketing: Campaign Performance</b></summary>
<br>
...
<details>
<summary><b>Day 6 — 🏦 Banking/Finance: Loan Default Analysis</b></summary>
<br>
...
<details>
<summary><b>Day 7 — 🍔 Food Delivery: Operations Performance</b></summary>
<br>
...
| Domain | Core Technique | Business Outcome |
|--------|----------------|-------------------|
...
> [!TIP]
> **Breadth over repetition.** Instead of ten notebooks on one dataset, this is *one method* proven across seven industries with completely different data shapes, KPIs, and audiences — retail merchandisers read differently than credit risk teams.
...
- ✅ **Stakeholder-first insights** — every case study ends in a decision, not just a chart
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/SankalpSinghRanaut)
